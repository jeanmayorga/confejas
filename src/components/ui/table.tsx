...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "h-9 border-r border-border/50 px-3 text-left align-middle font-medium whitespace-nowrap text-muted-foreground last:border-r-0 [&:has([role=checkbox])]:pr-0",
        className
      )}
      {...props}
    />
...
function TableCell({ className, ...props }: React.ComponentProps<"td">) {
  return (
    <td
      ...
      className={cn(
        "border-r border-border/50 px-3 py-[3px] align-middle whitespace-nowrap last:border-r-0 [&:has([role=checkbox])]:pr-0",
        className
      )}
      {...props}
    />
